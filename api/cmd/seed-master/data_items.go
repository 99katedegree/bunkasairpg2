...
// debuff は(1 - 耐性 + デバフ率) として耐性倍率に加算され、相手の耐性を削る。
//
// この非対称が攻略の肝になっている。
...
// --- 名前について -----------------------------------------------------------
//
// アイテム名も武器と同じく、落とす魔物から決まる。直接書き換えても次の生成で
// 戻るので、名前を変えたければ data_names.go を直すこと。
//
//	原型 プルヴィス が落とすもの         → ヴィスの鱗
//	亜種 プルヴィスイグニ が落とすもの    → イグニヴィスの鱗
//	亜種 スブプルヴィスシルワ が落とすもの → シルワヴィスの大鱗
//
// 末尾の部位が効果の軸を表す（牙=斬 / 拳=打 / 爪=射 / 石=無 / 焔=炎 /
// 鱗=水 / 蔓=森 / 羽=光 / 影=闇）。戦闘中に一覧から選ぶものなので、
// 雰囲気より「何に効くか」が読めることを優先している。
// 強いほうは「大」を冠し、デバフは「砕き」「断ち」で段を付ける。
// ============================================================================
...
var items = []ItemSeed{
	...
	{ID: 19, IndexNumber: "0019", Name: "イグニヴィスの鱗", EffectType: EffectBuff, Rate: 0.3, Target: Water},
	{ID: 20, IndexNumber: "0020", Name: "シルワヴィスの大鱗", EffectType: EffectBuff, Rate: 0.8, Target: Water},
	{ID: 21, IndexNumber: "0021", Name: "ルクスヴィスの蔓", EffectType: EffectBuff, Rate: 0.3, Target: Wood},
	{ID: 22, IndexNumber: "0022", Name: "ウンブラヴィスの大蔓", EffectType: EffectBuff, Rate: 0.8, Target: Wood},
	{ID: 23, IndexNumber: "0023", Name: "ツェルの羽", EffectType: EffectBuff, Rate: 0.3, Target: Shine},
	{ID: 24, IndexNumber: "0024", Name: "ウンブラツェルの大羽", EffectType: EffectBuff, Rate: 0.8, Target: Shine},
	{ID: 25, IndexNumber: "0025", Name: "フェルツェルの影", EffectType: EffectBuff, Rate: 0.3, Target: Dark},
	...
	{ID: 28, IndexNumber: "0028", Name: "フェルスガの牙断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Slash},
	{ID: 29, IndexNumber: "0029", Name: "イグニスガの拳砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Blow},
	{ID: 30, IndexNumber: "0030", Name: "シルワスガの拳断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Blow},
	{ID: 31, IndexNumber: "0031", Name: "ルクススガの爪砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Shoot},
	...
	{ID: 38, IndexNumber: "0038", Name: "ウンブラミアの鱗断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Water},
	{ID: 39, IndexNumber: "0039", Name: "フェルミアの蔓砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Wood},
	...
	{ID: 43, IndexNumber: "0043", Name: "シルワエラの影砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Dark},
	{ID: 44, IndexNumber: "0044", Name: "ウンダラスの影断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Dark},
}
