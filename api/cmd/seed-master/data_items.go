...
var items = []ItemSeed{
	...
	{ID: 19, IndexNumber: "0019", Name: "イグニの鱗", EffectType: EffectBuff, Rate: 0.3, Target: Water},
	{ID: 20, IndexNumber: "0020", Name: "シルワの大鱗", EffectType: EffectBuff, Rate: 0.8, Target: Water},
	{ID: 21, IndexNumber: "0021", Name: "ルクスの蔓", EffectType: EffectBuff, Rate: 0.3, Target: Wood},
	{ID: 22, IndexNumber: "0022", Name: "ウンブラの大蔓", EffectType: EffectBuff, Rate: 0.8, Target: Wood},
	{ID: 23, IndexNumber: "0023", Name: "ツェルの羽", EffectType: EffectBuff, Rate: 0.3, Target: Shine},
	{ID: 24, IndexNumber: "0024", Name: "ウンブラの大羽", EffectType: EffectBuff, Rate: 0.8, Target: Shine},
	{ID: 25, IndexNumber: "0025", Name: "フェルの影", EffectType: EffectBuff, Rate: 0.3, Target: Dark},
	...
	{ID: 28, IndexNumber: "0028", Name: "フェルの牙断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Slash},
	{ID: 29, IndexNumber: "0029", Name: "イグニの拳砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Blow},
	{ID: 30, IndexNumber: "0030", Name: "シルワの拳断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Blow},
	{ID: 31, IndexNumber: "0031", Name: "ルクスの爪砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Shoot},
	...
	{ID: 38, IndexNumber: "0038", Name: "ウンブラの鱗断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Water},
	{ID: 39, IndexNumber: "0039", Name: "フェルの蔓砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Wood},
	...
	{ID: 43, IndexNumber: "0043", Name: "シルワの影砕き", EffectType: EffectDebuff, Rate: 0.5, Target: Dark},
	{ID: 44, IndexNumber: "0044", Name: "ウンダの影断ち", EffectType: EffectDebuff, Rate: 1.0, Target: Dark},
}
